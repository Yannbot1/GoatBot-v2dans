...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += `\n𝗔𝗰𝘁𝘂𝗲𝗹𝗹𝗲𝗺𝗲𝗻𝘁,𝗹𝗲 𝗯𝗼𝘁 𝗱𝗶𝘀𝗽𝗼𝘀𝗲 𝗱𝗲 ${totalCommands} 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘂𝘁𝗶𝗹𝗶𝘀𝗮𝗯𝗹𝗲\n`;
      msg += `\n𝗧𝘆𝗽𝗲 ${prefix}𝗵𝗲𝗹𝗽 𝗰𝗺𝗱𝗡𝗮𝗺𝗲 𝗽𝗼𝘂𝗿 𝘃𝗼𝗶𝗿 𝗹𝗲𝘀 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 𝗱𝗲 𝗰𝗲𝘁𝘁𝗲 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝗲\n`;
      msg += `\n🫧𝑩𝑶𝑻 𝑵𝑨𝑴𝑬🫧:╾⸻⟡⟡ 『ᏦᎽᎾᎿᎯᏦᎯ』 ⟡⟡⸻╼`;
      msg += `\n𓀬 𝐁𝐎𝐓 𝐎𝐖𝐍𝐄𝐑 𓀬`;
      msg += `\n 	 					`;
      msg += `\n~𝙉𝘼𝙈𝙀:ʚɸɞ ᎠᎯᏁ ᏠᎬᏒᏕᎬᎽ ʚɸɞ`;
      msg += `\n~𝙁𝘽:1https://www.facebook.com/profile.php?id=61577043882265`;
      ...
      if (!command) {
        ...
        const response = `╭── 𝑵𝑨𝑴𝑬 ────⭓\n` +
          ...
          `│ ${usage}\n` +
          `├── 𝑵𝑶𝑻𝑬𝑺\n` +
          `│ 𝑇ℎ𝑒 𝑐𝑜𝑛𝑡𝑒𝑛𝑡 𝑖𝑛𝑠𝑖𝑑𝑒  ᎠᎯᏁ ᏠᎬᏒᏕᎬᎽ  𝑐𝑎𝑛 𝑏𝑒 𝑐ℎ𝑎𝑛𝑔𝑒𝑑\n` +
          `│ ♕︎ 𝐎𝐖𝐍𝐄𝐑 ♕︎:ʚɸɞ ᎠᎯᏁ ᏠᎬᏒᏕᎬᎽ ʚɸɞ\n` +
          `╰━━━━━━━❖`;
